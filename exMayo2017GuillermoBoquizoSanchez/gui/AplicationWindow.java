package exMayo2017GuillermoBoquizoSanchez.gui;
...
import exMayo2017GuillermoBoquizoSanchez.funcionalidad.*;
import java.io.File;
...
public class AplicationWindow {
	...
	/**
	 * Método que permite abrir un archivo, controlando que la opción para
	 * abrirlo lo permita, excluyendo el resto de opciones y saliendo del método
	 */
	private void abrir() {
		if (guardarSiModificado() == ContinuarAbortar.ABORTAR) {
			return;
